    ...
    <header>
        ...
        <nav>
            <ul class="nav-links">
                ...
                <li><a href="puzzle.php" class="active">ألعاب بازل</a></li>
    ...
    <main>
        <section class="games-section">
            ...
            <div class="games-grid">
                <a href="game.php?id=tic-tac-toe" class="game-item">
                    <img src="https://cdn.ttt4.com/maher/images/thumbnail/tic-tac-toe.jpg" class="game-image">
                    <div class="game-title">اكس او</div>
                </a>
                ...
                <a href="game.php?id=cannon-basketball-4" class="game-item">
                    <img src="https://cdn.ttt4.com/maher/images/thumbnail/cannon-basketball-4.jpg" class="game-image">
                    <div class="game-title">مدفع كرات السله</div>
                </a>
