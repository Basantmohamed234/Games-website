    ...
    <header>
        ...
        <nav>
            <ul class="nav-links">
                ...
                <li><a href="war.php" class="active">ألعاب حربية</a></li>
    ...
    <main>
        <section class="games-section">
            ...
            <div class="games-grid">
                <a href="game.php?id=warfare-1917" class="game-item">
                    <img src="https://cdn.ttt4.com/maher/images/thumbnail/warfare-1917.jpg" class="game-image">
                    <div class="game-title">حرب</div>
                </a>
                
                <a href="game.php?id=tanks-battle" class="game-item">
                    <img src="https://cdn.ttt4.com/maher/images/thumbnail/tanks-battle.jpg" class="game-image">
                    <div class="game-title">حرب الدبابات</div>
                </a>
                
                <a href="game.php?id=mexico-rex" class="game-item">
                    <img src="https://cdn.ttt4.com/maher/images/thumbnail/mexico-rex.jpg" class="game-image">
                    <div class="game-title">ديناصور المكسيك</div>
                </a>
