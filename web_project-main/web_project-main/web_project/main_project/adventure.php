    ...
    <header>
        ...
        <nav>
            <ul class="nav-links">
                ...
                <li><a href="adventure.php" class="active">ألعاب مغامرات</a></li>
        ...
        <section class="games-section">
            ...
            <div class="games-grid">
                ...
                <a href="game.php?id=frozen-double-trouble" class="game-item">
                    ...
                    <div class="game-title">اناو اليس</div>
                </a>
                ...
                <a href="game.php?id=batman-in-cobblebot-caper" class="game-item">
                    <img src="https://cdn.ttt4.com/maher/images/thumbnail/batman-in-cobblebot-caper.jpg" class="game-image">
                    <div class="game-title">بات مان</div>
                </a>
